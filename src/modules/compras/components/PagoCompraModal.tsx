...
export function PagoCompraModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Registrar Pago de Compra">
            ...
            {/* ── Footer ── */}
            <div className="mt-6 pt-5 border-t border-primary-100 flex gap-3">
                <Button
                    type="button"
                    variant="secondary"
