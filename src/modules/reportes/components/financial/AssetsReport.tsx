  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="p-10 rounded-[40px] bg-primary-900 text-white shadow-2xl shadow-primary-200 overflow-hidden relative group">
         ...
         <p className="text-xs font-black uppercase tracking-[0.4em] text-primary-400">Total Activos Consolidados</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-8 rounded-[32px] border border-primary-100 shadow-sm hover:border-primary-300 transition-all">
          <p className="text-xs font-black text-primary-400 uppercase tracking-widest mb-4">Efectivo y Equivalentes</p>
        ...
        <div className="bg-white p-8 rounded-[32px] border border-primary-100 shadow-sm hover:border-primary-300 transition-all">
          <p className="text-xs font-black text-primary-400 uppercase tracking-widest mb-4">Inventarios de Mercancía</p>
