...
export function SidebarGroup({ label, icon: IconComponent, collapsed, children }: SidebarGroupProps) {
    ...
    return (
        <div className="space-y-1">
          ...
          ${isChildActive && !isOpen && !collapsed ? "bg-accent-50 text-accent-700" : "text-primary-500 hover:bg-primary-100 hover:text-primary-900"}
            ...
            >
                <div className="flex items-center gap-3">
                    <IconComponent
                        ...
                        className={`shrink-0 transition-colors ${(isChildActive && !collapsed) ? "text-accent-600" : "text-primary-400 group-hover:text-primary-900"}`}
                    />
