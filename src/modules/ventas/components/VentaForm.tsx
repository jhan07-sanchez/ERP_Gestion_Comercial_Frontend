                      ...
                      >
                        ...
                        <div className="col-span-1 md:col-span-2 flex justify-center md:justify-start">
                          <div className="relative w-full max-w-[140px]">
                            <span className="absolute left-2 top-1/2 -translate-y-1/2 text-[10px] font-bold text-gray-400">{simbolo}</span>
                            <input
                              type="text"
        ...
        <Card className="border-none shadow-xl bg-white text-gray-900 overflow-hidden ring-1 ring-gray-200 sticky top-6">
          ...
          <Card.Content className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center text-gray-500">
                <span className="text-sm font-medium text-blue-600">Impuestos (IVA {impuestoPorcentaje}%)</span>
                <span className={`font-bold text-blue-700 ${numberClass}`}>
                  {formatCurrency((value.total || 0) * (impuestoPorcentaje / 100))}
                </span>
              </div>
              <div className="flex justify-between items-center text-gray-500">
                <span className="text-sm font-medium">Descuentos</span>
                <span className={`font-bold text-gray-700 ${numberClass}`}>{formatCurrency(0)}</span>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-medium">{moneda} - {simbolo}</p>
                  </div>
                </div>
        ...
        <div className="p-5 bg-blue-50/50 border border-blue-100 rounded-2xl hidden lg:block">
          ...
          <div className="space-y-3">
            <p className="text-[10px] text-blue-800/70 leading-relaxed">
              <span className="font-bold text-blue-900">IVA:</span> Se aplica automáticamente el {impuestoPorcentaje}% según configuración.
            </p>
            <p className="text-[10px] text-blue-800/70 leading-relaxed">
              <span className="font-bold text-blue-900">STOCK:</span> {permitirVentaSinStock ? 'Permitido vender sin stock.' : 'Venta bloqueada si no hay stock.'}
            </p>
          </div>
        </div>
      </div>
