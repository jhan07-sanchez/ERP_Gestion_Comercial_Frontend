      ...
      <PageContainer>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="max-w-md w-full text-center space-y-6 bg-rose-50/50 p-10 rounded-3xl border border-rose-100 shadow-sm backdrop-blur-sm">
            ...
            <Button 
                onClick={refresh} 
                className="w-full h-12 bg-rose-600 hover:bg-rose-700 text-white border-none shadow-xl shadow-rose-200 font-black uppercase tracking-widest text-xs"
            >
      ...
      <PageContainer>
        <div className="space-y-8 animate-pulse">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 h-[400px] bg-slate-100 rounded-3xl" />
  ...
  return (
    <PageContainer>
      <div className="relative">
        ...
        {isRefreshing && (
          <div className="fixed bottom-10 right-10 z-50 flex items-center gap-2 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-blue-100 shadow-2xl animate-in fade-in slide-in-from-bottom-5">
            <IconRefresh size={14} className="text-blue-600 animate-spin" />
        ...
        <div className="space-y-10 pb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <>
                  <section className="space-y-6">
                      <div className="flex items-center gap-3 px-2">
                          ...
                          <div>
                              <h2 className="text-sm font-black text-slate-800 uppercase tracking-tight">Operaciones del Día</h2>
                              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Últimas acciones registradas</p>
                          </div>
                      </div>
                      <ActivityTable activities={data.recentActivities} />
                  </section>
            ...
            <aside className="lg:col-span-4 space-y-10">
              ...
              <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-blue-700 p-8 text-white shadow-xl shadow-blue-200/50 relative overflow-hidden group">
                  ...
                  <div className="relative z-10 space-y-4">
                      ...
                      <Button variant="secondary" className="bg-white text-blue-700 border-none font-black text-[10px] uppercase tracking-widest h-10 w-full hover:bg-slate-50 transition-all shadow-lg active:scale-95">
