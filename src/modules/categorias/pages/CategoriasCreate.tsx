            ...
            <Card.Content className="p-4">
              ...
              <div className="space-y-2">
                <div className="text-xs">
                  <p className="font-bold text-primary-900">Electrónica</p>
                  <p className="text-primary-600">Dispositivos y accesorios</p>
                </div>
                <div className="border-t border-primary-100 pt-2 text-xs">
                  <p className="font-bold text-primary-900">Ropa</p>
                  <p className="text-primary-600">Prendas de vestir</p>
                </div>
                <div className="border-t border-primary-100 pt-2 text-xs">
                  <p className="font-bold text-primary-900">Alimentos</p>
                  <p className="text-primary-600">Productos comestibles</p>
                </div>
              </div>
            </Card.Content>
          </Card>
