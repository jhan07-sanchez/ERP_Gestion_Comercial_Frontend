                    ...
                    <div className="space-y-1.5 focus-within:relative z-10">
                        ...
                        <div className="relative">
                            <select
                                ...
                                disabled={submitting}
                                className="w-full h-11 px-4 appearance-none font-bold text-sm text-primary-700 bg-primary-50/50 border border-primary-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-accent-500/10 focus:border-accent-500 transition-all cursor-pointer"
                            >
