  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="p-10 rounded-[40px] bg-white border-2 border-danger-100 shadow-2xl shadow-danger-50 overflow-hidden relative group">
         ...
         <p className="text-xs font-black uppercase tracking-[0.4em] text-danger-400">Total Pasivos y Obligaciones</p>
      </div>

      <div className="bg-danger-50/30 p-8 rounded-[32px] border border-danger-100 flex justify-between items-center">
        <div>
          <p className="text-xs font-black text-danger-600 uppercase tracking-wider mb-1">Cuentas por Pagar</p>
      ...
      <div className="p-6 bg-primary-50 rounded-2xl border border-primary-100 italic text-xs text-primary-400 text-center">
