...
export default function VentaCreate() {
  ...
  return (
    <PageContainer>
      ...
      {!isCajaAbierta && (
        <Card className="border-danger-100 bg-danger-50/30 overflow-hidden animate-in fade-in zoom-in-95 duration-500">
      ...
      {isCajaAbierta && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="p-5 bg-accent-50/50 border border-accent-100 rounded-2xl flex gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-accent-900 mb-1 uppercase tracking-wider">💡 Tip de Ventas</h3>
