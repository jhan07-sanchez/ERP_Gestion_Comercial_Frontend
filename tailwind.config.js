  ...
  theme: {
    extend: {
      colors: {
        ...
        // ─── AZUL EMPRESARIAL (antes: blue, indigo) ───
        // Color de acción principal para CTAs, links, elementos interactivos
        accent: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // ─── VERDE — estados positivos (antes: green, emerald) ───
        success: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // ─── AMARILLO — advertencias (antes: yellow, amber) ───
        warning: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
        ...
        // ─── ROJO — errores y peligro (antes: red) ───
        danger: {
          50: '#fef2f2',
          100: '#fee2e2',
          200: '#fecaca',
        ...
        // ─── INFO — alias de accent para alertas/badges ───
        info: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
