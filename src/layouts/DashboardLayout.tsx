                ...
                <>
                  ...
                  {openMenu === item.label &&
                    item.children?.map((section) => (
                      <div
                        key={section.section}
                        className="ml-4 mt-1 mb-3 bg-gray-100 rounded-md py-2"
                      >
                        ...
                        {section.items.map((sub) => (
                          <Link
                            key={sub.label}
                            to={sub.path}
                            className="block px-6 py-2 text-sm text-gray-700 hover:bg-gray-200 hover:text-gray-900 transition-colors duration-150"
                          >
                            {sub.label}
                          </Link>
                        ))}
